...
void ASandboxGameCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ASandboxGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASandboxGameCharacter::Move);
...
void ASandboxGameCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
